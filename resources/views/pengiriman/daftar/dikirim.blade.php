...
<div class="container mx-auto">
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold text-gray-800">Dikirim</h1>
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <span class="mx-2 text-gray-500">/</span>
                            <span class="text-green-500">Dikirim</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="bg-white rounded-md shadow-sm overflow-hidden">
        ...
        <div class="p-4 flex flex-wrap items-center gap-2">
            <div class="relative flex-grow max-w-md">
                <form action="{{ route('pengiriman.dikirim') }}" method="GET" class="flex">
                    <input type="text" 
                           name="search" 
            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="relative group">
                    <button id="exportBtn" class="flex items-center p-2 border border-gray-300 rounded-md hover:bg-gray-50">
                    ...
                    <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg hidden group-hover:block z-10">
                        <div class="py-1">
                            <a href="{{ route('pengiriman.export', ['format' => 'pdf', 'status' => 'processed']) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="far fa-file-pdf mr-2 text-red-500"></i> Ekspor PDF
                            </a>
                            <a href="{{ route('pengiriman.export', ['format' => 'excel', 'status' => 'processed']) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="far fa-file-excel mr-2 text-green-600"></i> Ekspor Excel
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                            {{ $item->opsiPengiriman->tipe_pengiriman ?? 'Publik' }}
                        </td>
                        <td class="px-4 py-4 whitespace-nowrap">
                    ...
                    <tr>
                        <td colspan="12" class="px-4 py-8 text-center text-gray-500">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-lg font-medium">Tidak ada data pengiriman dikirim</p>
                                <p class="text-sm">Belum ada pengiriman dengan status dikirim</p>
...
<div id="filterPopup" class="fixed inset-0 bg-black bg-opacity-30 flex items-start justify-center z-50 pt-16 hidden">
    <div class="bg-white rounded-md shadow-lg w-full max-w-2xl">
        ...
        <div class="p-6">
            <form id="filterForm" action="{{ route('pengiriman.dikirim') }}" method="GET">
                <!-- Hidden status field to ensure we're filtering dikirim status -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('refreshBtn').addEventListener('click', function() {
        window.location.href = '{{ route("pengiriman.dikirim") }}';
    });
